...
📄 [Academic CV](assets/files/Academic_CV_ThanhNoiPhan.pdf)

For non-academic and professional opportunities:

📄 [Professional CV](assets/files/Professional_CV_ThanhNoiPhan.pdf)
...
![#00CCBB](https://placehold.co/10x10/00CCBB/00CCBB.png) Ecological & Environmental Analysis <br> 

- Ecological and environmental data integration <br> 
- Cross-scale ecological analysis <br> 
- Biodiversity and ecosystem monitoring <br> 
- Climate and land-use change analyses <br> 

![#00CCBB](https://placehold.co/10x10/00CCBB/00CCBB.png) Quantitative & Spatial Methods <br> 

- Machine learning for environmental applications <br> 
- Reproducible environmental workflows <br> 
- GIS and spatial analysis <br> 
- Earth Observation data processing <br> 
- Land-cover mapping and classification <br> 

![#00CCBB](https://placehold.co/10x10/00CCBB/00CCBB.png) Field & Collaborative Research <br> 

- Field campaign coordination and ecological sampling <br> 
- Interdisciplinary collaboration <br> 
- Ecological interpretation across environmental gradients <br> 

![#00CCBB](https://placehold.co/10x10/00CCBB/00CCBB.png) Programming & Tools <br> 

- R, Python, Google Earth Engine <br> 
- ArcGIS, QGIS, ENVI <br> 
- Git/GitHub <br> 
